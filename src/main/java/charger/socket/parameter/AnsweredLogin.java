package charger.socket.parameter;

import charger.socket.utils.constant.ChargerEVCConstant;

public class AnsweredLogin {
    private String chargerId;

    public AnsweredLogin(String chargerId) {
        this.chargerId = chargerId;
    }

    public byte [] answredLogin() {
        ...
        for(int i = 0; i < chargerId.length(); i+= 2) {
            ...
            if(i == 16) {
                ...
                index++;
                hexdata[index] = ChargerEVCConstant.LOGIN;
